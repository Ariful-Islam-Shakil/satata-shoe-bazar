            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2 border text-blue-900 font-semibolds"
                />
              </div>
            </div>
